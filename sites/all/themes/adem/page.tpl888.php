...
<?php print render($page['english']); ?>
        ...
        <div class="divider-vertical"></div>
        <div class="nav-container phone"> <a href="contact">Enquiry</a> <?php print render($page['help']); ?></div>
  ...
  <div class="slide slide3 background" style="opacity: 1;">
              ...
              <div class="container_19 slide-inner-wrapper">
                <div class="row">
                  ...
                  <ul id="verticals">
                    <li title="Cms" style="cursor: pointer; " value="click here" onclick="location.href='node/7'" id="vertical-marketing" class="span3">
                       <?php if ($page['hosting']): ?><?php print render($page['hosting']); ?><?php endif; ?>
                    </li>
                    <li title="E-Commerce" style="cursor: pointer; " value="click here" onclick="location.href='node/8'" id="vertical-sales" class="span3">
                       <?php if ($page['apps']): ?><?php print render($page['apps']); ?><?php endif; ?>
                    </li>
                    </li>
                    <li title="Mobile Apps" style="cursor: pointer; " value="click here" onclick="location.href='node/38'" id="vertical-support" class="span3">
                       <?php if ($page['tourism']): ?><?php print render($page['tourism']); ?><?php endif; ?>
                    </li>
                    </li>
                    <li title="Products" style="cursor: pointer; " value="click here" onclick="location.href='product'" id="vertical-platform" class="span3">
            ...
            <div class="banner">
              <h2>Assisteed web Solutions © 1999 - <?php echo date("Y");?> </h2>
            </div>
            </a>
      ...
      <div class="inner column center" id="content-inner">
        ...
        <div id="content-area">
          <div class="region region-content">
            ...
            <?php else :
            if (module_exists('i18n_menu')) {
            $main_menu_tree = i18n_menu_translated_tree(variable_get('menu_main_links_source', 'menu-tools-menu'));
            } else {
            $main_menu_tree = menu_tree(variable_get('menu_main_links_source', 'menu-tools-menu')); 
            }
            print drupal_render($main_menu_tree);
            endif; ?>
